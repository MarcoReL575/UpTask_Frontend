...
export default function ChangePasswordView() {
  ...
  const handleChangePassword = (formData : UpdatePassword) => mutate(formData)
        ...
        >
          ...
          <div className="flex items-center justify-center">
            <input
              ...
              className="bg-olivine-600 px-20 py-3 text-white uppercase font-bold rounded hover:bg-olivine-700 cursor-pointer transition-colors"
            />
          </div>
        </form>
      </div>
