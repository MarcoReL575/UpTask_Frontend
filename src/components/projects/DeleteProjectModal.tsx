...
export default function DeleteProjectModal() {
    ...
    const checkUserPasswordMutatio = useMutation({
    ...
    const handleForm = async (formData: CheckPasswordForm) => {
        await checkUserPasswordMutatio.mutateAsync(formData)
                            ...
                            <DialogPanel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-16">
                                ...
                                >
                                    ...
                                    <div className='flex justify-center items-center'>
                                        <input
                                            type="submit"
                                            className=" bg-olivine-600 hover:bg-olivine-700 px-20 py-3 rounded text-white font-black  text-xl cursor-pointer"
